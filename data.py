...
import re
import torchvision
from utils.auto_augement import ReIDPolicy
...
class Data():
    def __init__(self):
        ...
        if opt.cj > 0:
            transform_list.append(transforms.RandomApply([transforms.ColorJitter(brightness=0.5,contrast=0.5,saturation=0.5,hue=0)]))
...
class Vehicle_Reid(dataset.Dataset):
    def __init__(self, transform, mode, data_path):
        ...
        if mode == 'train':
            ...
            self.data_path += '/gallery'
        else:
            self.data_path += '/probe'
    ...
    def id(file_path):
        """
        :param file_path: single image path    ../pytorch/train_all/0088/0088_c016_00059430_0.jpg
