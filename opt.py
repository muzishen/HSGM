...
parser.add_argument('--data_path', default="../pytorch", help='path of Vehicle image')
parser.add_argument('--num_classes', default=576,type=int, help='classes number. VeRi776: 576;  ')
parser.add_argument('--seed', default=2020,type=int, help='random seed;  ')
########################################  Dataload    ###################################################
parser.add_argument("--name", default='part4_randomcrop',type=str, help='the name of log')
...
parser.add_argument('--mean', default=[0.418, 0.323, 0.340],type=float, help='mean of veri776 image =[0.418,0.323,0.340],normal: [0.485, 0.456, 0.406],veID:[0.391,0.411,0.411]')
parser.add_argument('--std', default=[0.183, 0.160, 0.164],type=float, help='std of veri776 image =[0.183,0.160,0.164], normal:[0.229, 0.224, 0.225],veID:[0.246, 0.243, 0.243]')
...
parser.add_argument('--pad', default=0, type=float, help='pading')
...
parser.add_argument('--resume',          default=0, help='0: do not use resume trainning' )
...
parser.add_argument('--model_weight',  default='150',  help='load choice weights number for test ')
